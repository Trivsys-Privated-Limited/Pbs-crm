...
Route::middleware(CheckOfficeIP::class)->group(function () {
    Route::controller(dashboardController::class)->group(function () {
        ...
        // Old Numbers Region Wise Routes
        Route::get('/old-numbers/{region}', [dashboardController::class, 'viewOldNumbersByRegion'])->name('viewOldNumbersByRegion');
        Route::get('/distribute-old-numbers/{region}', [dashboardController::class, 'distributeOldNumbersFormByRegion'])->name('distributeOldNumbersFormByRegion');
        Route::post('/store-distributed-old-numbers/{region}', [dashboardController::class, 'storeDistributedOldNumbersByRegion'])->name('storeDistributedOldNumbersByRegion');
