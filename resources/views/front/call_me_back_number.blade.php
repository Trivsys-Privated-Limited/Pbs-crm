...
@section('home')
 <div class="w-full h-[80px] flex justify-center place-items-center bg-indigo-600">
    <span class="text-white text-2xl font-bold">Call Me Back Customer Numbers</span>
</div>
                ...
                @forelse($supportNumbers as $key => $customer)
                    <tr class="odd:bg-gray-50 even:bg-white">
                        ...
                        <td class="px-4 py-2 border text-center">
                            <span class="px-3 py-1 text-white text-sm rounded-full bg-indigo-600">
                                {{ $customer->status }}
                            </span>
                        </td>
