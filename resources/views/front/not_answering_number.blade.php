...
@section('home')
 <div class="w-full h-[80px] flex justify-center place-items-center bg-amber-500">
    <span class="text-white text-2xl font-bold">Not Answering Customer Numbers</span>
</div>
                ...
                @forelse($supportNumbers as $key => $customer)
                    <tr class="odd:bg-gray-50 even:bg-white">
                        ...
                        <td class="px-4 py-2 border text-center">
                            <span class="px-3 py-1 text-white text-sm rounded-full bg-amber-500">
                                {{ $customer->status }}
                            </span>
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center py-5 text-gray-500">
                            No Not Answering Numbers Found
                        </td>
                    </tr>
                @endforelse
            </tbody>
