...
@section('home')
 <div class="w-full h-[80px] flex justify-center place-items-center bg-red-700">
    <span class="text-white text-2xl font-bold">Non Satisfied Customer Numbers</span>
</div>
    <div class="w-full mx-auto mt-5 mb-5 overflow-x-auto">
        <!-- <h2 class="text-xl font-bold mb-4 text-red-700">Non Satisfied Support Numbers</h2> -->
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center py-5 text-gray-500">
                            No Non Satisfied Numbers Found
                        </td>
                    </tr>
                @endforelse
            </tbody>
