...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Sales Coordinator Complete Track Report</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-4 col-6">
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3>{{ $totalAssigned }}</h3>
                            <p>Total Data Assigned by Coordinator</p>
                        </div>
                        <div class="icon">
            ...
            <div class="row mb-4">
                <!-- Support Team Summary (Kis Support Agent ko Kitna Data Mila) -->
                <div class="col-md-6">
                ...
                <!-- Status Tracking Summary (Un Leads Par Kitna Kaam Hua) -->
                <div class="col-md-6">
                        ...
                        <tbody>
                            @forelse ($coordinatorData as $key => $row)
                                <tr>
                                    ...
                                    <td><small class="text-muted">{{ $row->assigned_by_name ?? 'System' }}</small></td>
                                    
                                    <!-- Naya Join Kiya Hua Data (Support User Name) -->
                                    <td>
