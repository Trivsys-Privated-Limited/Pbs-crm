                ...
                <div class="col-12 mt-4">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="text-center">Distribute Multiple Leads To Another Agent</h3>
                        </div>
                        <form action="{{ route('saveMultipleLeadDistribution') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="p-2 border rounded bg-light" style="max-height: 150px; overflow-y: auto;">
                                            <ul class="list-unstyled mb-0">
                                                @foreach($selected_customers as $customer)
                                                    <li class="mb-1">
                                                        <i class="fa-solid fa-user text-muted mr-1"></i> 
