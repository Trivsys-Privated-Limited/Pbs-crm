                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    @if (Auth::user()->role === 'admin')
                       ...
                       {{-- <li class="nav-item">
                        ...
                        <!-- Start Old number Regional Links -->

                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fa-solid fa-phone"></i>
                                <p>
                                    Regional Old Numbers
                                    <i class="fas fa-angle-left right"></i>
                                </p>
                            </a>
                            <ul class="nav nav-treeview">
                                <!-- US/CA (+1) -->
                                <li class="nav-item">
                                    <a href="{{ route('viewOldNumbersByRegion', 'us') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>All US Old Numbers</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('distributeOldNumbersFormByRegion', 'us') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon text-success"></i>
                                        <p>Distribute US Old Numbers</p>
                                    </a>
                                </li>

                                <!-- UK (+44) -->
                                <li class="nav-item mt-2">
                                    <a href="{{ route('viewOldNumbersByRegion', 'uk') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>All UK Old Numbers</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('distributeOldNumbersFormByRegion', 'uk') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon text-success"></i>
                                        <p>Distribute UK Old Numbers</p>
                                    </a>
                                </li>

                                <!-- AUS (+61) -->
                                <li class="nav-item mt-2">
                                    <a href="{{ route('viewOldNumbersByRegion', 'aus') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>All AUS Old Numbers</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('distributeOldNumbersFormByRegion', 'aus') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon text-success"></i>
                                        <p>Distribute AUS Old Numbers</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
